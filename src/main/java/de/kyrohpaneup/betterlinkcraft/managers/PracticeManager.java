...
public class PracticeManager {
    ...
    public void switchServer() {
        ...
        if (mc.getCurrentServerData() != null && mc.getCurrentServerData().serverIP != null && mc.getCurrentServerData().serverIP.equalsIgnoreCase("linkcraft.mcpro.io")) {
            ...
            mc.addScheduledTask(() -> {
                if (mc.theWorld != null) {
                    ...
                    connectionManager.joinServerWithCallback("linkcraft.mcpro.io", () -> {});
                }
            });
        }
    }
